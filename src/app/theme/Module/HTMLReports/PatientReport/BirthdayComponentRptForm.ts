...
declare var $: any;
@Component({
    selector: 'BirthdayComponentRptForm',
    templateUrl: 'BirthdayComponentRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class BirthdayComponentRptForm implements OnInit {
    ...
    RunReport() {
        this.loader.ShowLoader();
        this.reportservice.BirthdayRpt(this.model).then(m => {
