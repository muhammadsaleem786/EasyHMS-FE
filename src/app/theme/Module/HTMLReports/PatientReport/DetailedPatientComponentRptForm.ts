...
declare var $: any;
@Component({
    selector: 'DetailedPatientComponentRptForm',
    templateUrl: 'DetailedPatientComponentRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class DetailedPatientComponentRptForm implements OnInit {
    ...
    RunReport() {
        this.loader.ShowLoader();
        this.reportservice.DetailedPatientRpt(this.model).then(m => {
