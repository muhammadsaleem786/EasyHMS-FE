...
@Component({
    selector: 'PaymentComponentRptForm',
    templateUrl: 'PaymentComponentRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class PaymentComponentRptForm implements OnInit {
    ...
    RunReport() {
        ...
        if (this.model.PatientName == null || this.model.PatientName == "")
            this.model.PatientId = null;
        this.reportservice.PaymentRpt(this.model).then(m => {
