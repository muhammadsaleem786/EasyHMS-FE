...
@Component({
    selector: 'PaymentSummaryRptForm',
    templateUrl: 'PaymentSummaryRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class PaymentSummaryRptForm implements OnInit {
    ...
    RunReport() {
        this.loader.ShowLoader();
        this.reportservice.PaymentSummaryRpt(this.model).then(m => {
