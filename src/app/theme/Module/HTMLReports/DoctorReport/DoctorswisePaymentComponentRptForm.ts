...
@Component({
    selector: 'DoctorswisePaymentComponentRptForm',
    templateUrl: 'DoctorswisePaymentComponentRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class DoctorswisePaymentComponentRptForm implements OnInit {
    ...
    RunReport() {
        ...
        if (this.model.DoctorName == null || this.model.DoctorName == "")
            this.model.DoctorId = null;
        this.reportservice.DoctorswisePaymentRpt(this.model).then(m => {
