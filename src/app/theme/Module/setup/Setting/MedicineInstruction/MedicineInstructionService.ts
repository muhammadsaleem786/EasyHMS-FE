...
@Injectable()
export class MedicineInstructionService {
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Appointment/emr_instruction"
    ...
    SaveOrUpdate(entity: emr_instruction): Promise<any> {
