...
export class UserRoleComponentForm implements OnInit {
    ...
    GetScreensOfModule(ModuleID) {
        if (this.PayrollRegion == 'SA') {
            return this.ScreenLists.filter(x => x.ModuleID == ModuleID && x.ScreenID != 8 && x.ScreenID != 25 && x.ScreenID != 26);
        } else {
    ...
    ShowScreenName(ScreenID) {
        ...
        if (Active[0].ScreenName == "Estimate")
            IsShowScreen = this.CompanyInfo[0].gen_IsEstimate
        else if (Active[0].ScreenName == "Sale Order")
            IsShowScreen = this.CompanyInfo[0].gen_IsSalesOrder
        else if (Active[0].ScreenName == "Purchase Order")
            IsShowScreen = this.CompanyInfo[0].gen_IsPurchaseOrder
        else if (Active[0].ScreenName == "Retainer Invoice")
            IsShowScreen = this.CompanyInfo[0].gen_IsRetainerInvoice
        else if (Active[0].ScreenName == "Recurring Invoices")
            IsShowScreen = this.CompanyInfo[0].gen_IsRecurringInvoice
        else if (Active[0].ScreenName == "Recurring Expenses")
            IsShowScreen = this.CompanyInfo[0].gen_IsRecurringExpense
        else if (Active[0].ScreenName == "Recurring Bills")
            IsShowScreen = this.CompanyInfo[0].gen_IsRecurringBill

        //else if (Active[0].ScreenName == "Estimate")
        //    IsShowScreen = this.CompanyInfo[0].gen_IsRecurringJournal
