...
export class ProfileUserComponentForm implements OnInit {
    ...
    ngOnInit() {
        ...
        //    if (m.IsSuccess) this.RoleList = m.ResultSet;
        //});
    ...
    //MatchesFound() {
    //    if (this.model.adm_user_company[0].EmployeeID == undefined) {
    //        this.DisplayMember = ''; this.model.adm_user_company[0].EmployeeID = undefined;
    //    }
    //}
    onRoleChange(event) {
