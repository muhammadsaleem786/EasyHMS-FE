...
export class MedicineService {
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Appointment/emr_medicine"
    ...
    GetMedicineById(Id: number): Promise<any> {
        var data = { 'Id': Id };
        return this.http.Get(this.urlToApi + '/GetMedicineById', data).then(e => e);
    }
    
    SaveOrUpdate(entity: emr_medicine): Promise<any> {
