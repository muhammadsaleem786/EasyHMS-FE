...
export class PayrollComponentList {
    ...
    public payrolShow: boolean = false;
    ...
    ngOnInit() {
        ...
        this.PConfig.Fields = [
            ...
            { Name: "Tax", Title: "Tax", OrderNo: 6, SortingAllow: true, Visible: true, isDate: false, DateFormat: "", IsShowCurrency: true },
            { Name: "NetSalary", Title: "Net Salary", OrderNo: 7, SortingAllow: true, Visible: true, isDate: false, DateFormat: "", IsShowCurrency: true },
        ];
    ...
    AdjustmentEditClick(AllowDedIDOrVal, Type, RefID) {
        ...
        //} else {
        //    this.model.pr_employee_payroll_dt[this.AdjustmentValueClickIndex].AdjustmentAmount = 0;
        //    this.model.pr_employee_payroll_dt[this.AdjustmentValueClickIndex].AdjustmentComments = '';
        //    this.model.pr_employee_payroll_dt[this.AdjustmentValueClickIndex].AdjustmentDate = new Date();
        //    this.model.pr_employee_payroll_dt[this.AdjustmentValueClickIndex].AdjustmentType = 'C';
        //}
