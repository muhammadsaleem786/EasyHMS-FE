...
export class EmployeeComponentList {
    ...
    //public PBulkEmpModel = new PaginationModel();
    //public PBulkEmpConfig = new PaginationConfig();
    ...
    constructor(public _fb: FormBuilder, public _CommonService: CommonService, public _router: Router
        , public loader: LoaderService, public _EmployeeService: EmployeeService, public toastr: CommonToastrService
    ) {
    ...
    ngOnInit() {
        ...
        this.PConfig.Action.ScreenName = "Employees";
