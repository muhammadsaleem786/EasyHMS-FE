...
export class departmentService {
    ...
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/pr_department"
    ...
    SaveOrUpdate(entity: departmentModel): Promise<any> {
    ...
    SaveAndReturnDeptList(entity: departmentModel): Promise<any> {
