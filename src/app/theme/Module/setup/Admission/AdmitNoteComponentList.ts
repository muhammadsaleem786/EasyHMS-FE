...
export class AdmitNoteComponentList implements OnInit {
    ...
    NoteGridList() {
        ...
        this.Id = "0";
        this._AdmitService.GetNoteList(this.PModel.CurrentPage, this.PModel.RecordPerPage, this.PModel.VisibleColumnInfo, this.PModel.SortName, this.PModel.SortOrder, this.PModel.SearchText, this.AdmitId, this.PatientId, this.Appointmentid).then(m => {
    ...
    NoteSaveOrUpdate(isValid: boolean): void {
        if (isValid) {
            ...
            this.noteModel.AppointmentId = this.Appointmentid;
