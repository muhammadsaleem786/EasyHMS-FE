...
import { emr_patient, ipd_admission, ipd_admission_vital, ipd_admission_notes, ipd_procedure_charged, ipd_admission_lab, ipd_admission_charges, ipd_admission_medication, ipd_admission_imaging, ipd_procedure_mf, ipd_procedure_medication, ipd_diagnosis, ipd_admission_discharge } from './AdmitModel';
...
export class AdmitService {
    ...
    ChargeGetById(AdmitId: string, PatientId: string, Appointmentid: string): Promise<any> {
        var data = { 'AdmitId': AdmitId, 'PatientId': PatientId, 'Appointmentid': Appointmentid };
