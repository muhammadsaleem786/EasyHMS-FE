...
@Component({
    templateUrl: './BillComponentForm.html',
    moduleId: module.id,
    providers: [AppointmentService, BillingService, PatientService],
})

export class BillComponentForm implements OnInit {
    ...
    public Total: number = 0; public Form9: FormGroup;
    public TotalDiscount: number = 0;
    public Rights: any;
    public ControlRights: any; public CompanyObj: any;
    ...
    ngOnInit() {
        ...
        this.BillModel.PatientId = this.PatientId; 
        this.BillModel.PatientName = localStorage.getItem('PatientName'); 
