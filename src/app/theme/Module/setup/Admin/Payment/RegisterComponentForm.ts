...
export class RegisterComponentForm implements OnInit {
    ...
    constructor(public _fb: FormBuilder, public companyService: CompanyService,public _router: Router,public accountService: AccountService, public commonservice: CommonService,
